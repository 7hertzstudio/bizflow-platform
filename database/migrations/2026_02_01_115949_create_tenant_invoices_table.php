...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('tenant_invoices', function (Blueprint $table) {
            ...
            // Reference
            $table->string('invoice_number')->unique(); // INV-10001
            $table->foreignUlid('quote_id')->nullable()->constrained('tenant_quotes')->onDelete('set null'); // Converted from quote?
            ...
            $table->decimal('rounding_adjustment', 15, 2)->default(0); // +0.43 to make it clean
            $table->decimal('total', 15, 2)->default(0);

            // Status
            $table->string('status')->default('draft'); // draft, sent, paid, past_due, void
