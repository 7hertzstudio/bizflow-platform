...
namespace App\Filament\Resources\TenantQuotes\Schemas;
...
class TenantQuoteForm
{
    ...
    public static function updateTotals($get, $set): void
    {
        $state = [
            ...
            'rounding_adjustment' => 0, // Not in Quote schema yet but good for future
        ];
